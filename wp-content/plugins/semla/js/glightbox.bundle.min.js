...
!function(){for(var e=document.querySelectorAll(".wp-block-gallery.is-style-lightbox"),l=[],t=e.length;t--;){var o=e[t],r=o.className.match(/wp-block-gallery-\d+/);r?((r=GLightbox({selector:"."+r+" a"})).on("slide_before_load",a),l.push(r)):console.error("Cannot extract gallery id from "+o.className)}function a(e){var l,e=e.slideConfig;e.title||(l=document.querySelector('.wp-block-gallery.is-style-lightbox a[href="'+e.href+'"] > img'))&&(e.title=l.getAttribute("title")||"")}}();